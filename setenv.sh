...
SLAVE_START=$PENTAHO_HOME/design-tools/data-integration/start_cluster_slaves.sh
SLAVE_STOP=$PENTAHO_HOME/design-tools/data-integration/stop_cluster_slaves.sh
